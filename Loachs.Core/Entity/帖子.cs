...
namespace Loachs.Entity
{
    ...
    public partial class Posts : IPosts
    {
        ...
        [Description("是否允许评论")]
        [DataObjectField(false, false, false, 10)]
        [BindColumn(9, "commentstatus", "是否允许评论", null, "int", 10, 0, false)]
        ...
        /// <summary>URL类型,见枚举PostUrlFormat</summary>
        [DisplayName("URL类型,见枚举PostUrlFormat")]
        [Description("URL类型,见枚举PostUrlFormat")]
        [DataObjectField(false, false, true, 10)]
        [BindColumn(13, "urlformat", "URL类型", null, "int", 10, 0, false)]
