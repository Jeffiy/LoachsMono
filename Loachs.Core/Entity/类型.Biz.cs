...
{
    /// <summary>类型</summary>
    public partial class Terms<TEntity> : LogEntity<TEntity>
          where TEntity : Terms<TEntity>, new()
    {
        #region 对象操作﻿
        static Terms()
        {
        ...
        /// <summary>根据slug查找</summary>
        /// <param name="slug"></param>
        /// <returns></returns>
        [DataObjectMethod(DataObjectMethodType.Select, false)]
        public static TEntity FindBySlug(string slug)
        {
            if (Meta.Count >= 1000)
