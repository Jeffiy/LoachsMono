...
{
    /// <summary>分类</summary>
    public class Categorys : Terms<Categorys>
    {
        #region 对象操作﻿
...
//            if (isNew && !Dirtys[__.CreateDate]) CreateDate = DateTime.Now;
        ...
        /// Finds all Category.
        /// </summary>
        public new static EntityList<Categorys> FindAll()
        {
            return FindAll(__.Type, (int)TermType.Category);
        }

        /// <summary>
        /// Finds all Category with cache.
        /// </summary>
        public new static EntityList<Categorys> FindAllWithCache()
        {
            return FindAllWithCache(__.Type, (int)TermType.Category);
        }

        /// <summary>
        /// Finds the Category count.
        /// </summary>
        public new static int FindCount()
        {
            return FindCount(__.Type, (int)TermType.Category);
        }
        #endregion
