...
namespace Loachs.Data
{
    ...
    public partial class Links : LogEntity<Links>
    {
        ...
        #region 扩展查询
        /// <summary>根据Linkid查找</summary>
        /// <param name="linkid"></param>
        /// <returns></returns>
        [DataObjectMethod(DataObjectMethodType.Select, false)]
        public static Links FindByLinkid(Int32 linkid)
        {
            if (Meta.Count >= 1000)
                return Find(_.Id, linkid);
            else // 实体缓存
                return Meta.Cache.Entities.Find(__.Id, linkid);
            // 单对象缓存
            //return Meta.SingleCache[linkid];
        }
        #endregion
