...
namespace Loachs.Data
{
    ...
    public partial class Comments : LogEntity<Comments>
    {
        ...
        /// <summary>根据Commentid查找</summary>
        /// <param name="commentid"></param>
        /// <returns></returns>
        [DataObjectMethod(DataObjectMethodType.Select, false)]
        public static Comments FindByCommentid(Int32 commentid)
        {
            if (Meta.Count >= 1000)
                return Find(_.Id, commentid);
            else // 实体缓存
                return Meta.Cache.Entities.Find(__.Id, commentid);
            // 单对象缓存
            //return Meta.SingleCache[commentid];
        }
        #endregion
